...
*/
   ...
   var commandlist = [ /*Can be populated with various methods*/
      ["help", "Show commands"],
      ["lshw", "Show information about me"],
      ["bash projects.sh", "Run my projects list"],
      ["list", "List all information pages on the website"],
   ...
   var pages = [ /*Can be populated with various methods*/
      ["index", "Welcome to guysgarcia.xyz", "To get started simply write [lshw] to read more information about me", "After you could write [bash projects.sh] and see a list of all the projects I have worked on."],
      ["about", "This website is an interactive personal CV", "In the future I plan to integrade my AI (Atlas) into the website", "It was a learning exercise to learn more about JS", "This program was originally made from koya.io but since the webpage has long been replaced I decided to fix some of the code and make it my own."],
      ["contact", "Send me an email, i'm always available!",
      "[mailto:guy.garcia@upr.edu](Email guy.garcia@upr.edu)",
      "[](GitHub)"]
   ];
   var pageindex = ["index", "about", "contact"];
   var currentpage = "landing";
   var url = "http://guysgarcia.xyz/"
      /*
         Custom Text Syntax
         Links:      
   ...
   function init() {
      ...
      log("Website", "A! _____         _____ _____             _     ");
      log("Website", "A!|   __|_ _ _ _|   __|   __|___ ___ ___|_|___ ");
      log("Website", "A!|  |  | | | | |__   |  |  | .'|  _|  _| | .'|");
      log("Website", "A!|_____|___|_  |_____|_____|__,|_| |___|_|__,|");
      log("Website", "");
      urlvars();
      log("Website", "");
      log("Client", "For help write 'help'");
